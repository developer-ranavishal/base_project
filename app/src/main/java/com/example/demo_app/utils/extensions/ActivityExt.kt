...
import com.example.demo_app.databinding.InfoDialogBinding
...
fun Activity.showInfoDialog(icon: Int, title: Int) {
    val dialog = BottomSheetDialog(this, R.style.BottomSheetDialog)
    val infoDialogBinding: InfoDialogBinding = DataBindingUtil.inflate(LayoutInflater.from(this), R.layout.info_dialog, null, false)
